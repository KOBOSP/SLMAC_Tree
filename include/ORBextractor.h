...
protected:
     ...
     */
    void GetPyramidImage(cv::Mat image);
     ...
     * @param[in] nKPNeed                 设定的、本图层中想要提取的特征点数目
    ...
    float mfscaleFactor;		                    ///<图像金字塔层与层之间的缩放因子
    int mnlevels;			                    ///<图像金字塔的层数
    int mniniThFAST;			                    ///<初始的FAST响应值阈值
    int mnminThFAST;			                    ///<最小的FAST响应值阈值
