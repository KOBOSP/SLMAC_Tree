...
public:
     ...
     * @see CreateInitialMapMonocular() TrackWithReferenceKeyFrame() Relocalization()
     */
    void ComputeBoW();
     ...
     */
    bool IsPosInGrid(const cv::KeyPoint &kp, int &posX, int &posY);
...
public:
    ...
    // 观测不到Map中的3D点
    /// 属于外点的特征点标记,在 Optimizer::OptimizeFramePose 使用了
