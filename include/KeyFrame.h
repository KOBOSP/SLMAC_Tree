 ...
 */
    ...
    public:
        ...
        /** @brief 更新图的连接  */
        void UpdateConnectedKeyFrameAndWeights();

        /**
         * @brief 按照权重对连接的关键帧进行排序
         * @detials 更新后的变量存储在mvpOrderedConnectedKeyFrames和mvOrderedWeights中
         */
        void UpdateCovisibleKeyFrameandWeights();

        /**
         * @brief 得到与该关键帧连接的关键帧(没有排序的)
         * @return 连接的关键帧
         */
        std::set<KeyFrame *> GetCovisibleKeyFrames();
         ...
         * @return 连接的关键帧
         */
        std::vector<KeyFrame *> GetCovisibilityForefrontKeyFrames(const int &N);
         ...
         * @param  minObs 最小观测
         */
        int GetNumMapPointsBigObs(const int &minObs);
    ...
    public:
        ...
        long unsigned int mnFrameIDShareWord;
