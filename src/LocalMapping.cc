 ...
 */
    void LocalMapping::CreateNewMapPoints() {
        ...
        for (size_t i = 0; i < vpNeighKFs.size(); i++) {
            ...
            matcher.SearchKFAndKFByTriangulation(mpCurrentKeyFrame, pKF2, F12, vMatchedIndices, false);
 ...
 */
    void LocalMapping::FuseMapPointsInNeighbors() {
        ...
        for (vector<KeyFrame *>::iterator vit = vpTargetKFs.begin(), vend = vpTargetKFs.end(); vit != vend; vit++) {
            ...
            matcher.SearchReplaceKFAndMPsByProjectInLocalMap(pKFi, vpMapPointMatches);
        }
        ...
        matcher.SearchReplaceKFAndMPsByProjectInLocalMap(mpCurrentKeyFrame, vpFuseCandidates);
